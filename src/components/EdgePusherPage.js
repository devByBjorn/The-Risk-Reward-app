  ...
  <PageMainContainter>
    <FlexContainer alignItems="center" flexDirection="column" justifyContent="center">
      <ContentWrapper>
        ...
        <Paragraph ><Span display="inline" fontWeight="bold">When it comes to trading you need to know your edge. EdgePusher aims to help you identify your true edge in the market, so you can stop putting on risk blindly and instead push your true edge fully.</Span>
        </Paragraph>
      </ContentWrapper>
      ...
      <ContentWrapper>
        ...
        <Paragraph>
          Then you have the tables, and here is where the magic lies. One table shows specific stats based on markets and the other shows the same stats based on setups. The idea is that you should compare the tables and identify your setups with the highest win rate and your best performing market. With this knowledge you can focus on your highest probability setups in your best performing market, and really push those trades
    </Paragraph>
        <Paragraph>
    ...
    <Span fontWeight="normal">EdgePusher team</Span>
        ...
        <Span fontSize="1.2rem" fontWeight="normal">*If you are not familiar with R and R-multiple read <a href="https://www.vantharp.com/trading/wp-content/uploads/2018/06/A_Short_Lesson_on_R_and_R-multiple.pdf">A Short Lesson on R and R-multiple</a> from The Van Tharp Institute</Span>
      </ContentWrapper>
