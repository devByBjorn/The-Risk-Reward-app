  ...
  <PageMainContainter>
    <FlexContainer alignItems="center" flexDirection="column" justifyContent="center">
      <ContentWrapper>
        ...
        <Paragraph ><Span display="inline" fontWeight="bold">The market is a tuff place for a trader just starting out</Span>. One of the biggest issues for many new trades is undercapitalization. A small account size can make it hard to take the game serious, and lack of seriousness can easily lead you to blindly take too much risk. This often leads to another blown trading account.
        </Paragraph>
        <Paragraph>This can be avoided if you follow the process presented below. The process is especially suitable if you are trying to grow a small amount of money and do not have the luxury of risking only 0.5% - 1%, or even 2%, of your account. The two keystones of the process is logging trades and comparing stats (a great deal of patience is needed too).</Paragraph>
      </ContentWrapper>
      ...
      <ContentWrapper>
        ...
        <Paragraph>
          With this knowledge you should focus on only trading your highest probability setups in your best performing market, and really push those trades. Remember that you will need a good amount of trades before you can draw any conclusions based on the statistics.
    </Paragraph>
      </ContentWrapper>
